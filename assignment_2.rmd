...
\Leftrightarrow W_n  &> z_{0.05} * \left( \sqrt{\frac{n_1n_2(n+1)}{12} - \frac{n_1n_2\sum\limits_{i=1}^{k}(t_i^3 -t_i)}{12n(n+1)}} \right) +\frac{n_1(n+1)}{2}
\end{align*}
...
such that $W_n =\sum\limits_{i=1}^n iS_i(X,Y) = m$.
