...
lmedfit <- lmsreg(y~x,data=data1)
abline(coef=coefficients(lmedfit),col="blue",lwd=2)
robfit <- rlm(y~x,data=data1,method="M",psi = psi.bisquare,
...
abline(coef=coefficients(lmedfit),col="blue",lwd=2)
robfit <- rlm(y~x,data=data2,method="M",psi = psi.bisquare,
              init=coefficients(lmedfit)) 
abline(coef = coefficients(robfit), col="magenta", lwd=2)
...
abline(coef=coefficients(lmedfit),col="blue",lwd=2)
robfit <- rlm(y~x,data=data3,method="MM",psi = psi.bisquare,
              init=coefficients(lmedfit)) 
abline(coef = coefficients(robfit), col="magenta", lwd=2)
...
abline(coef=coefficients(lmedfit),col="blue",lwd=2)
robfit <- rlm(y~x,data=data4,method="M",psi = psi.bisquare,
              init=coefficients(lmedfit)) 
abline(coef = coefficients(robfit), col="magenta", lwd=2)
